...
AP_Task Tracker::scheduler_tasks[] = {
    ...
    make_task("AP_BattMonitor::read",   &tracker.battery,   &AP_BattMonitor::read,  10,   1500),
    ...
    make_task("AP_Baro::accumulate",    &tracker.barometer, &AP_Baro::accumulate,   50,   900),
    make_task("ten_hz_logging_loop",    &tracker, &Tracker::ten_hz_logging_loop,    10,   300),
    make_task("DataFlash_Class::periodic_tasks",   &tracker.DataFlash, &DataFlash_Class::periodic_tasks, 50,  300),
    make_task("AP_InertialSensor::periodic", &tracker.ins,       &AP_InertialSensor::periodic, 50,   50),
    make_task("AP_Notify::update",      &tracker.notify,    &AP_Notify::update,     50,    100),
